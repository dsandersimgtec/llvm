...
public:
  ...
  ///
  PPCSubtarget(const TargetTuple &TT, const std::string &CPU,
...
public:
  ...
  bool isDarwin() const { return TheTargetTuple.isMacOSX(); }
  /// isBGQ - True if this is a BG/Q platform.
  bool isBGQ() const { return TheTargetTuple.getVendor() == TargetTuple::BGQ; }
